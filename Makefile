...
GEN_PB_SERVICE_TS  = protoc -I=$(GOPATH)/src --plugin=protoc-gen-ts=$(PROTOC_GEN_TS) --js_out=import_style=browser,binary:$(GOPATH)/src --ts_out=service=grpc-web:$(GOPATH)/src

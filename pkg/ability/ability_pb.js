...
proto.ability.Ability.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(8, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeEnum);
  }
 ...
 * @return {!jspb.Map<string,!proto.ability.Target>}
 */
proto.ability.Ability.prototype.getTargetsMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.ability.Target>} */ (
 ...
 * @return {!proto.ability.Ability} returns this
 */
proto.ability.Ability.prototype.clearTargetsMap = function() {

...
proto.ability.Effect.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    amount: (f = msg.getAmount()) && proto.ability.Amount.toObject(includeInstance, f),
    drain: (f = msg.getDrain()) && proto.ability.Amount.toObject(includeInstance, f),
    draintargetsMap: (f = msg.getDraintargetsMap()) ? f.toObject(includeInstance, undefined) : [],
    duration: jspb.Message.getFieldWithDefault(msg, 7, 0),
    icon: msg.getIcon_asB64(),
    stackrules: (f = msg.getStackrules()) && proto.ability.StackRules.toObject(includeInstance, f),
    delay: jspb.Message.getFieldWithDefault(msg, 10, 0),
    repeat: jspb.Message.getFieldWithDefault(msg, 11, 0)
  };
...
proto.ability.Effect.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 6:
      var value = msg.getDraintargetsMap();
      reader.readMessage(value, function(message, reader) {
...
proto.ability.Effect.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getDraintargetsMap(true);
  if (f && f.getLength() > 0) {
...
/**
 * map<string, Target> DrainTargets = 6;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.ability.Target>}
 */
proto.ability.Effect.prototype.getDraintargetsMap = function(opt_noLazyCreate) {
 ...
 * @return {!proto.ability.Effect} returns this
 */
proto.ability.Effect.prototype.clearDraintargetsMap = function() {
  this.getDraintargetsMap().clear();
  return this;};
...
proto.ability.Component.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(2, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.ability.Effect.serializeBinaryToWriter);
  }
  f = message.getTriggersMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(3, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.ability.Trigger.serializeBinaryToWriter);
  }
};
 ...
 * @return {!jspb.Map<string,!proto.ability.Target>}
 */
proto.ability.Component.prototype.getTargetsMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.ability.Target>} */ (
 ...
 */
proto.ability.Component.prototype.clearTargetsMap = function() {
  this.getTargetsMap().clear();
  return this;};


/**
 * map<string, Effect> Effects = 2;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.ability.Effect>}
 */
proto.ability.Component.prototype.getEffectsMap = function(opt_noLazyCreate) {
 ...
 * @return {!proto.ability.Component} returns this
 */
proto.ability.Component.prototype.clearEffectsMap = function() {
  this.getEffectsMap().clear();
  return this;};


/**
 * map<string, Trigger> Triggers = 3;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.ability.Trigger>}
 */
proto.ability.Component.prototype.getTriggersMap = function(opt_noLazyCreate) {
 ...
 * @return {!proto.ability.Component} returns this
 */
proto.ability.Component.prototype.clearTriggersMap = function() {
...
proto.ability.Ability.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    componentsMap: (f = msg.getComponentsMap()) ? f.toObject(includeInstance, proto.ability.Component.toObject) : []
  };
...
proto.ability.Ability.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 8:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.ability.Component.deserializeBinaryFromReader, "", new proto.ability.Component());
         });
      break;
    default:
      reader.skipField();
...
proto.ability.Ability.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f && f.getLength() > 0) {
    f.serializeBinary(8, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeMessage, proto.ability.Component.serializeBinaryToWriter);
  }
};
 ...
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,!proto.ability.Component>}
 */
proto.ability.Ability.prototype.getComponentsMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,!proto.ability.Component>} */ (
      jspb.Message.getMapField(this, 8, opt_noLazyCreate,
      proto.ability.Component));
};
 ...
 * @return {!proto.ability.Ability} returns this
 */
proto.ability.Ability.prototype.clearComponentsMap = function() {

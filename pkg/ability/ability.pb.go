...
type Target struct {
	...
	Closest bool  `protobuf:"varint,3,opt,name=Closest,proto3" json:"Closest,omitempty"`
	Range   int64 `protobuf:"varint,4,opt,name=Range,proto3" json:"Range,omitempty"`
	// optionals
	Radius int64 `protobuf:"varint,5,opt,name=Radius,proto3" json:"Radius,omitempty"`
	...
	MoveTarget MoveTarget `protobuf:"bytes,8,opt,name=MoveTarget,proto3" json:"MoveTarget"`
}
...
var fileDescriptor_23b56474bae35107 = []byte{
	...
	,
}
...
func (this *Target) GoString() string {
	...
	s = append(s, "Closest: "+fmt.Sprintf("%#v", this.Closest)+",\n")
	s = append(s, "Range: "+fmt.Sprintf("%#v", this.Range)+",\n")
	s = append(s, "Radius: "+fmt.Sprintf("%#v", this.Radius)+",\n")
	s = append(s, "Width: "+fmt.Sprintf("%#v", this.Width)+",\n")
	s = append(s, "Height: "+fmt.Sprintf("%#v", this.Height)+",\n")
	s = append(s, "MoveTarget: "+strings.Replace(this.MoveTarget.GoString(), `&`, ``, 1)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Target) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.MoveTarget.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	if len(m.GroupID) > 0 {
		...
		i = encodeVarintAbility(dAtA, i, uint64(len(m.GroupID)))
		i--
		dAtA[i] = 0x12
	}
	if m.Type != 0 {
...
func NewPopulatedMoveTarget(r randyAbility, easy bool) *MoveTarget {
	...
	this.TargetType = TargetType([]int32{0, 1, 2, 3, 4, 5, 6}[r.Intn(7)])
...
func NewPopulatedTarget(r randyAbility, easy bool) *Target {
	this := &Target{}
	this.Type = TargetType([]int32{0, 1, 2, 3, 4, 5, 6}[r.Intn(7)])
	v2 := r.Intn(100)
	this.GroupID = make([]byte, v2)
	for i := 0; i < v2; i++ {
		this.GroupID[i] = byte(r.Intn(256))
	}
	this.Closest = bool(bool(r.Intn(2) == 0))
	...
	v3 := NewPopulatedMoveTarget(r, easy)
	this.MoveTarget = *v3
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedEffectModifier(r randyAbility, easy bool) *EffectModifier {
	...
	v6 := NewPopulatedStackRules(r, easy)
	this.StackRules = *v6
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func (this *Target) String() string {
	...
	s := strings.Join([]string{`&Target{`,
		...
		`Closest:` + fmt.Sprintf("%v", this.Closest) + `,`,
		`Range:` + fmt.Sprintf("%v", this.Range) + `,`,
		`Radius:` + fmt.Sprintf("%v", this.Radius) + `,`,
		`Width:` + fmt.Sprintf("%v", this.Width) + `,`,
		`Height:` + fmt.Sprintf("%v", this.Height) + `,`,
		`MoveTarget:` + strings.Replace(strings.Replace(this.MoveTarget.String(), "MoveTarget", "MoveTarget", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Target) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Closest", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {

...
type U struct {
	...
	FirebaseID github_com_elojah_game_03_pkg_ulid.ID `protobuf:"bytes,4,opt,name=FirebaseID,proto3,customtype=github.com/elojah/game_03/pkg/ulid.ID" json:"FirebaseID"`
}
...
var fileDescriptor_1133aa3887fb7186 = []byte{
	...
	0x7c, 0x7d, 0xb0, 0x64, 0x52, 0x69, 0x1a, 0x98, 0x07, 0xe6, 0x80, 0x59, 0x10, 0x4d, 0x4a, 0x87,
	0x19, 0xb9, 0x18, 0x43, 0x85, 0x6c, 0xb9, 0x98, 0x3c, 0x5d, 0x24, 0x18, 0x15, 0x18, 0x35, 0x78,
	0x9c, 0x74, 0x4f, 0xdc, 0x93, 0x67, 0xb8, 0x75, 0x4f, 0x5e, 0x95, 0x80, 0xed, 0x39, 0x99, 0x29,
	0x7a, 0x9e, 0x2e, 0x41, 0x4c, 0x9e, 0x2e, 0x42, 0x22, 0x5c, 0xac, 0xae, 0xb9, 0x89, 0x99, 0x39,
	0x12, 0x4c, 0x0a, 0x8c, 0x1a, 0x9c, 0x41, 0x10, 0x8e, 0x90, 0x14, 0x17, 0x47, 0x40, 0x62, 0x71,
	0x71, 0x79, 0x7e, 0x51, 0x8a, 0x04, 0x33, 0xc8, 0xe8, 0x20, 0x38, 0x5f, 0xc8, 0x97, 0x8b, 0xcb,
	0x2d, 0xb3, 0x28, 0x35, 0x29, 0xb1, 0x38, 0xd5, 0xd3, 0x45, 0x82, 0x85, 0x1c, 0x8b, 0x91, 0x0c,
	...
	0x72, 0x8c, 0x17, 0x1e, 0xcb, 0x31, 0xdc, 0x78, 0x2c, 0xc7, 0x90, 0xc4, 0x06, 0x0e, 0x12, 0x63,
	0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x06, 0xd1, 0x21, 0x93, 0x78, 0x01, 0x00, 0x00,
}
...
func (this *U) Equal(that interface{}) bool {
	...
	if !this.FirebaseID.Equal(that1.FirebaseID) {
		return false
	}
	return true
}
func (this *U) GoString() string {
	...
	s = append(s, "FirebaseID: "+fmt.Sprintf("%#v", this.FirebaseID)+",\n")
	s = append(s, "}")
...
func (m *U) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.FirebaseID.Size()
		i -= size
		if _, err := m.FirebaseID.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
...
func (this *U) String() string {
	...
	s := strings.Join([]string{`&U{`,
		...
		`FirebaseID:` + fmt.Sprintf("%v", this.FirebaseID) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *U) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FirebaseID", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.FirebaseID.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:

...
var fileDescriptor_e3cf22b654f0ce97 = []byte{
	...
	0x60, 0x0e, 0x98, 0x05, 0xd1, 0xa4, 0xb4, 0x94, 0x91, 0x8b, 0x3d, 0x18, 0x62, 0x8c, 0x90, 0x2d,
	...
	0x35, 0x0b, 0x89, 0x70, 0xb1, 0x86, 0xe4, 0x67, 0xa7, 0xe6, 0x49, 0x30, 0x2b, 0x30, 0x6a, 0x70,
	0x06, 0x41, 0x38, 0x4e, 0x1e, 0x27, 0x1e, 0xca, 0x31, 0x5c, 0x78, 0x28, 0xc7, 0x70, 0xe3, 0xa1,
	...
	0x63, 0x48, 0x62, 0x03, 0x7b, 0xdc, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x4c, 0x54, 0x90, 0xa8,
	0x61, 0x01, 0x00, 0x00,
}
...
func NewPopulatedSession(r randySession, easy bool) *Session {
	...
	this.UserID = *v2
	this.Token = string(randStringSession(r))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}

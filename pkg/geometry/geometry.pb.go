...
func (m *KClosest) Reset()      { *m = KClosest{} }
func (*KClosest) ProtoMessage() {}
func (*KClosest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6dc0e58235b9cb07, []int{1}
}
func (m *KClosest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *KClosest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_KClosest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *KClosest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_KClosest.Merge(m, src)
}
func (m *KClosest) XXX_Size() int {
	return m.Size()
}
func (m *KClosest) XXX_DiscardUnknown() {
	xxx_messageInfo_KClosest.DiscardUnknown(m)
}

var xxx_messageInfo_KClosest proto.InternalMessageInfo

func (m *KClosest) GetPosition() *Vec3 {
	if m != nil {
		return m.Position
	}
	return nil
...
func init() {
	...
	golang_proto.RegisterType((*Vec3)(nil), "geometry.Vec3")
	proto.RegisterType((*KClosest)(nil), "geometry.KClosest")
	golang_proto.RegisterType((*KClosest)(nil), "geometry.KClosest")
}
...
var fileDescriptor_6dc0e58235b9cb07 = []byte{
	...
	0x48, 0x10, 0x2f, 0x4a, 0x82, 0x19, 0xc2, 0x8b, 0x52, 0x72, 0xe1, 0xe2, 0xf0, 0x76, 0xce, 0xc9,
	0x2f, 0x4e, 0x2d, 0x2e, 0x11, 0xd2, 0xe2, 0xe2, 0x08, 0xc8, 0x2f, 0xce, 0x2c, 0xc9, 0xcc, 0xcf,
	0x03, 0x6b, 0xe6, 0x36, 0xe2, 0xd3, 0x83, 0xbb, 0x0c, 0x64, 0x6e, 0x10, 0x5c, 0x1e, 0x64, 0x8a,
	0x37, 0xd8, 0x4c, 0x96, 0x20, 0x46, 0x6f, 0x27, 0x97, 0x0b, 0x0f, 0xe5, 0x18, 0x6e, 0x3c, 0x94,
	...
	0x0c, 0x49, 0x6c, 0x60, 0x4f, 0x18, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0x53, 0xbd, 0xe4, 0x9e,
	0x36, 0x01, 0x00, 0x00,
}
...
func (this *KClosest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*KClosest)
	if !ok {
		that2, ok := that.(KClosest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *KClosest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&geometry.KClosest{")
...
func (m *KClosest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *KClosest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *KClosest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.K != 0 {
		i = encodeVarintGeometry(dAtA, i, uint64(m.K))
		i--
		dAtA[i] = 0x10
	}
	if m.Position != nil {
...
func NewPopulatedKClosest(r randyGeometry, easy bool) *KClosest {
	this := &KClosest{}
	if r.Intn(5) != 0 {
		this.Position = NewPopulatedVec3(r, easy)
	}
...
func (this *KClosest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&KClosest{`,
		`Position:` + strings.Replace(this.Position.String(), "Vec3", "Vec3", 1) + `,`,
...
func (m *KClosest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: KClosest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: KClosest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {

...
goog.exportSymbol('proto.room.Public', null, global);
 ...
 * @constructor
 */
proto.room.Public = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.room.Public, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.room.Public.displayName = 'proto.room.Public';
}
 ...
 * @return {!(string|Uint8Array)}
 */
proto.room.R.prototype.getOwnerid = function() {
 ...
 * @return {string}
 */
proto.room.R.prototype.getOwnerid_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getOwnerid()));
};
 ...
 * @return {!Uint8Array}
 */
proto.room.R.prototype.getOwnerid_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getOwnerid()));
};
 ...
 * @return {!proto.room.R} returns this
 */
proto.room.R.prototype.setOwnerid = function(value) {
 ...
 * @return {!Object}
 */
proto.room.Public.prototype.toObject = function(opt_includeInstance) {
  return proto.room.Public.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.room.Public} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.room.Public.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: msg.getId_asB64(),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.room.Public}
 */
proto.room.Public.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.room.Public;
  return proto.room.Public.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.room.Public} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.room.Public}
 */
proto.room.Public.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.room.Public.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.room.Public.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.room.Public} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.room.Public.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId_asU8();
  if (f.length > 0) {
    writer.writeBytes(
 ...
 * @return {!(string|Uint8Array)}
 */
proto.room.Public.prototype.getId = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 * @return {string}
 */
proto.room.Public.prototype.getId_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getId()));
};
 ...
 * @return {!Uint8Array}
 */
proto.room.Public.prototype.getId_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getId()));
};
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.room.Public} returns this
 */
proto.room.Public.prototype.setId = function(value) {
  return jspb.Message.setProto3BytesField(this, 1, value);
};
 ...
 * @return {!(string|Uint8Array)}
 */
proto.room.Public.prototype.getRoomid = function() {
  return /** @type {!(string|Uint8Array)} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {string}
 */
proto.room.Public.prototype.getRoomid_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getRoomid()));
};
 ...
 * @return {!Uint8Array}
 */
proto.room.Public.prototype.getRoomid_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getRoomid()));
};
 ...
 * @return {!proto.room.Public} returns this
 */
proto.room.Public.prototype.setRoomid = function(value) {
  return jspb.Message.setProto3BytesField(this, 2, value);
};

...
var fileDescriptor_8408f5360c24017c = []byte{
	...
	0xd1, 0xa4, 0xd4, 0xc8, 0xc8, 0xc5, 0xe2, 0x9c, 0x9a, 0x93, 0x23, 0xe4, 0xce, 0xc5, 0x1e, 0x9e,
	...
	0x01, 0xe2, 0x45, 0x4a, 0x30, 0x43, 0x78, 0x91, 0x42, 0x22, 0x5c, 0xac, 0x6e, 0x99, 0xa9, 0x39,
	0x29, 0x12, 0x2c, 0x20, 0x2b, 0x82, 0x20, 0x1c, 0x27, 0x97, 0x0b, 0x0f, 0xe5, 0x18, 0x6e, 0x3c,
	0x94, 0x63, 0xf8, 0xf0, 0x50, 0x8e, 0xf1, 0xc7, 0x43, 0x39, 0xc6, 0x86, 0x47, 0x72, 0x8c, 0x2b,
	0x1e, 0xc9, 0x31, 0xee, 0x78, 0x24, 0xc7, 0x78, 0xe0, 0x91, 0x1c, 0xe3, 0x89, 0x47, 0x72, 0x8c,
	0x17, 0x1e, 0xc9, 0x31, 0x3e, 0x78, 0x24, 0xc7, 0xf8, 0xe2, 0x91, 0x1c, 0xc3, 0x87, 0x47, 0x72,
	0x8c, 0x13, 0x1e, 0xcb, 0x31, 0x1c, 0x78, 0x2c, 0xc7, 0x78, 0xe1, 0xb1, 0x1c, 0xc3, 0x8d, 0xc7,
	0x72, 0x0c, 0x49, 0x6c, 0x60, 0x0f, 0x19, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xdf, 0x88, 0x5a,
	0xf5, 0x36, 0x01, 0x00, 0x00,
}
...
func (this *Cell) Equal(that interface{}) bool {
	...
	if !bytes.Equal(this.Field, that1.Field) {
		return false
	}
	return true
}
...
func (m *Cell) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Field) > 0 {
		i -= len(m.Field)
		copy(dAtA[i:], m.Field)
		i = encodeVarintCell(dAtA, i, uint64(len(m.Field)))
		i--
		dAtA[i] = 0x22
	}
	if m.Y != 0 {
...
func NewPopulatedCell(r randyCell, easy bool) *Cell {
	...
	v2 := r.Intn(100)
	this.Field = make([]byte, v2)
	for i := 0; i < v2; i++ {
		this.Field[i] = byte(r.Intn(256))
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this

...
type WorldSpawn struct {
	...
	OwnerID  github_com_elojah_game_03_pkg_ulid.ID `protobuf:"bytes,4,opt,name=OwnerID,proto3,customtype=github.com/elojah/game_03/pkg/ulid.ID" json:"OwnerID"`
}

func (m *WorldSpawn) Reset()      { *m = WorldSpawn{} }
func (*WorldSpawn) ProtoMessage() {}
func (*WorldSpawn) Descriptor() ([]byte, []int) {
	return fileDescriptor_9b8c51b337323916, []int{0}
}
func (m *WorldSpawn) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *WorldSpawn) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_WorldSpawn.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *WorldSpawn) XXX_Merge(src proto.Message) {
	xxx_messageInfo_WorldSpawn.Merge(m, src)
}
func (m *WorldSpawn) XXX_Size() int {
	return m.Size()
}
func (m *WorldSpawn) XXX_DiscardUnknown() {
	xxx_messageInfo_WorldSpawn.DiscardUnknown(m)
}

var xxx_messageInfo_WorldSpawn proto.InternalMessageInfo

func init() {
	proto.RegisterType((*WorldSpawn)(nil), "room.WorldSpawn")
	golang_proto.RegisterType((*WorldSpawn)(nil), "room.WorldSpawn")
}

func init() {
	proto.RegisterFile("github.com/elojah/game_03/pkg/room/spawn.proto", fileDescriptor_9b8c51b337323916)
}
func init() {
	golang_proto.RegisterFile("github.com/elojah/game_03/pkg/room/spawn.proto", fileDescriptor_9b8c51b337323916)
}

var fileDescriptor_9b8c51b337323916 = []byte{
	...
	,
	...
	0x07, 0x1e, 0xcb, 0x31, 0x5e, 0x78, 0x2c, 0xc7, 0x70, 0xe3, 0xb1, 0x1c, 0x43, 0x12, 0x1b, 0x38,
	0xec, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x52, 0x42, 0x65, 0x15, 0xe7, 0x01, 0x00, 0x00,
}

func (this *WorldSpawn) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*WorldSpawn)
	if !ok {
		that2, ok := that.(WorldSpawn)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *WorldSpawn) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&room.WorldSpawn{")
...
func (m *WorldSpawn) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *WorldSpawn) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *WorldSpawn) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func NewPopulatedWorldSpawn(r randySpawn, easy bool) *WorldSpawn {
	this := &WorldSpawn{}
...
func randFieldSpawn(dAtA []byte, r randySpawn, fieldNumber int, wire int) []byte {
	...
	case 0:
		...
		dAtA = encodeVarintPopulateSpawn(dAtA, uint64(v6))
	case 1:
		dAtA = encodeVarintPopulateSpawn(dAtA, uint64(key))
...
func (this *WorldSpawn) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&WorldSpawn{`,
...
func (m *WorldSpawn) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: WorldSpawn: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: WorldSpawn: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {

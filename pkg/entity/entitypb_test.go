...
func BenchmarkStatsProtoMarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*Stats, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedStats(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkStatsProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(NewPopulatedStats(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
...
func BenchmarkStatsSize(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*Stats, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedStats(popr, false)
	}
	b.ResetTimer()
